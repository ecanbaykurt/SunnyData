#!/usr/bin/env python3
"""
SunnySett Specialized Model: microsoft/layoutlmv3-base for Security Privacy
==================================================================
...
def main():
    ...
    print("SunnySett Security Privacy Model: microsoft/layoutlmv3-base")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Personally Identifiable Information detection")
