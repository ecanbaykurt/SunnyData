#!/usr/bin/env python3
"""
SunnySett Model: roberta-cybersec for Cybersecurity
=================================================

This script demonstrates how to use roberta-cybersec for text-classification
in cybersecurity applications.

Description: RoBERTa model fine-tuned for cybersecurity text analysis
...
def load_model():
    """Load the roberta-cybersec model and tokenizer."""
    try:
        from transformers import pipeline
        
        model_name = "roberta-cybersec"
...
def main():
    """Main function to run the roberta-cybersec analysis."""
    print("SunnySett Cybersecurity Model: roberta-cybersec")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: RoBERTa model fine-tuned for cybersecurity text analysis")
