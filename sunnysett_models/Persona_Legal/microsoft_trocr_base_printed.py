#!/usr/bin/env python3
"""
SunnySett Specialized Model: microsoft/trocr-base-printed for Persona Legal
==================================================================

This script demonstrates how to use microsoft/trocr-base-printed for image-to-text
in persona legal applications.

Description: Document text extraction and OCR
...
def main():
    ...
    print("SunnySett Persona Legal Model: microsoft/trocr-base-printed")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Document text extraction and OCR")
