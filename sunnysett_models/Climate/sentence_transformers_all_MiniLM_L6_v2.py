#!/usr/bin/env python3
"""
SunnySett Model: sentence-transformers/all-MiniLM-L6-v2 for Climate
=================================================================

This script demonstrates how to use sentence-transformers/all-MiniLM-L6-v2 for feature-extraction
in climate applications.

Description: Sentence transformer for climate document similarity
...
def main():
    ...
    print("SunnySett Climate Model: sentence-transformers/all-MiniLM-L6-v2")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Sentence transformer for climate document similarity")
