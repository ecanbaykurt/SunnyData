#!/usr/bin/env python3
"""
SunnySett Specialized Model: Helsinki-NLP/opus-mt-en-es for Persona Climate
==================================================================

This script demonstrates how to use Helsinki-NLP/opus-mt-en-es for translation
in persona climate applications.

Description: Multilingual climate research translation
...
def main():
    ...
    print("SunnySett Persona Climate Model: Helsinki-NLP/opus-mt-en-es")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Multilingual climate research translation")
