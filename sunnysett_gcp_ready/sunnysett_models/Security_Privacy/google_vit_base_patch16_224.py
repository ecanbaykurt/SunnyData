...
def main():
    ...
    print("SunnySett Security Privacy Model: google/vit-base-patch16-224")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Watermark and tamper detection")
