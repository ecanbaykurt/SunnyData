...
def load_model():
    """Load the google/tft model and tokenizer."""
    try:
...
def main():
    ...
    print("SunnySett Predictive Analytics Model: google/tft")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Complex multivariate time series forecasting")
