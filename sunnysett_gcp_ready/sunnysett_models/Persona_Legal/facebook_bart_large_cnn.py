#!/usr/bin/env python3
"""
SunnySett Specialized Model: facebook/bart-large-cnn for Persona Legal
=============================================================

This script demonstrates how to use facebook/bart-large-cnn for summarization
in persona legal applications.

Description: Legal document summarization
...
def main():
    ...
    print("SunnySett Persona Legal Model: facebook/bart-large-cnn")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Legal document summarization")
