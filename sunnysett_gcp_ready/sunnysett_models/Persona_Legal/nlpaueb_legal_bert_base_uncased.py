#!/usr/bin/env python3
"""
SunnySett Specialized Model: nlpaueb/legal-bert-base-uncased for Persona Legal
=====================================================================

This script demonstrates how to use nlpaueb/legal-bert-base-uncased for text-classification
in persona legal applications.

Description: Contract analysis and clause classification
...
def load_model():
    """Load the nlpaueb/legal-bert-base-uncased model."""
    try:
...
def main():
    ...
    print("SunnySett Persona Legal Model: nlpaueb/legal-bert-base-uncased")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Contract analysis and clause classification")
