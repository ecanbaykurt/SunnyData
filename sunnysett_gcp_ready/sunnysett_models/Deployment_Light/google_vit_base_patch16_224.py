...
def main():
    ...
    print("SunnySett Deployment Light Model: google/vit-base-patch16-224")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Efficient vision transformer")
