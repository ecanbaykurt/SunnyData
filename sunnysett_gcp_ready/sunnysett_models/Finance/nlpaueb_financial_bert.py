#!/usr/bin/env python3
"""
SunnySett Model: nlpaueb/financial-bert for Finance
=================================================

This script demonstrates how to use nlpaueb/financial-bert for text-classification
in finance applications.

Description: Financial BERT model for financial text understanding
...
Usage:
    python nlpaueb_financial_bert.py
"""
...
def load_model():
    """Load the nlpaueb/financial-bert model and tokenizer."""
    try:
        from transformers import pipeline
        
        model_name = "nlpaueb/financial-bert"
...
def main():
    """Main function to run the nlpaueb/financial-bert analysis."""
    print("SunnySett Finance Model: nlpaueb/financial-bert")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: Financial BERT model for financial text understanding")
