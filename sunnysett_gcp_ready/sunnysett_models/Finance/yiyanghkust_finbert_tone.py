#!/usr/bin/env python3
"""
SunnySett Model: yiyanghkust/finbert-tone for Finance
===================================================

This script demonstrates how to use yiyanghkust/finbert-tone for sentiment-analysis
...
Usage:
    python yiyanghkust_finbert_tone.py
"""
...
def load_model():
    """Load the yiyanghkust/finbert-tone model and tokenizer."""
    try:
...
def main():
    """Main function to run the yiyanghkust/finbert-tone analysis."""
    print("SunnySett Finance Model: yiyanghkust/finbert-tone")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: FinBERT model fine-tuned for financial sentiment analysis")
