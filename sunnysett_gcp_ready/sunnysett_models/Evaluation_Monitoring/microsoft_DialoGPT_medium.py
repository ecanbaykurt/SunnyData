#!/usr/bin/env python3
"""
SunnySett Specialized Model: microsoft/DialoGPT-medium for Evaluation Monitoring
=======================================================================

This script demonstrates how to use microsoft/DialoGPT-medium for text-classification
in evaluation monitoring applications.

Description: LLM-as-a-Judge for output evaluation
...
def main():
    ...
    print("SunnySett Evaluation Monitoring Model: microsoft/DialoGPT-medium")
    print("=" * 60)
    ...
    if classifier:
        ...
        print(f"2. Description: LLM-as-a-Judge for output evaluation")
